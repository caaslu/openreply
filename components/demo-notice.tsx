  ...
  return (
    <div className="relative mb-5 rounded border border-warning/30 bg-warning/10 px-4 py-3 pr-10">
      <p className="text-sm leading-6 text-foreground">
        <span className="font-semibold">{DEMO_HOST} é uma instância de demo.</span>{" "}
        Entrar aqui não envia DMs da sua conta do Instagram. O OpenReply é
        auto-hospedado, então só funciona em uma instalação que você mesmo
        executa, com o seu app da Meta e o seu domínio.{" "}
        <a
          href={SETUP_DOCS_URL}
          target="_blank"
          rel="noreferrer"
