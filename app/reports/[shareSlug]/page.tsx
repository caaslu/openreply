...
export async function generateMetadata({
  ...
  return {
    ...
    description: `Relatório somente leitura da campanha de comentário para DM no Instagram: ${report.campaign.name}.`,
    robots: { index: false, follow: false },
  };
}
      ...
      <section className="mx-auto w-full max-w-6xl px-5 py-10 sm:px-6 lg:px-8">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <MetricCard
            ...
            helper="Duplicadas, limites ou envios não realizados."
          />
          <MetricCard
            label="Falhas"
          ...
          <MetricCard
            ...
            helper="Visitas ao link rastreado a partir das respostas."
          />
          <MetricCard
            label="CTR"
              ...
              <div className="mt-5 space-y-3">
                {report.topKeywords.length === 0 && (
                  <p className="text-sm text-zinc-400">
                    Ainda não há dados de palavras-chave correspondidas.
                  </p>
                )}
            ...
            <section className="border border-white/10 bg-white/[0.035] p-4 sm:p-6">
              ...
              <div className="mt-5 space-y-3">
                {report.trackedLinks.length === 0 && (
                  <p className="text-sm text-zinc-400">
                    Esta campanha não tem um link rastreado.
                  </p>
                )}
        ...
        {report.branded && (
          <footer className="mt-8 border-t border-white/10 pt-6 text-center text-xs text-zinc-500">
            Relatório gerado por Designerz
          </footer>
        )}
      </section>
    </main>
