...
"eu quero","aqui está: {link}","te mandei um dm","https://seulink.com/oferta","oi! clique abaixo para receber","enviar link"
"LINK,LOJA","pega aqui: {link}","te chamei no dm",,,`;
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-muted mt-1">
          Cole um CSV com uma linha por campanha. Cada linha abre no editor
          ...
          ficam na mesma célula, separadas por vírgula. Use{" "}
